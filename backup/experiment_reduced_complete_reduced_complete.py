...
def train(model, lr_schedule, train_loader, pretrained_weights_directory):
    ...
    for batch_index, (point_clouds, labels, ground_truths) in enumerate(train_loader):
        ...
        point_clouds = point_clouds.transpose(2, 1)  # (batch_size, num_points, 3) -> (batch_size, num_points, 2048)
...
if __name__ == "__main__":
    ...
    log_file = get_log_file(train_shape="reduced_complete", test_shape="reduced_complete")
    pretrained_weights_directory = get_trained_model_directory(train_shape="reduced_complete",
                                                               test_shape="reduced_complete")
    # log_file = None
